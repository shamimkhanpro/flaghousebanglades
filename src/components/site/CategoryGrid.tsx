...
function waLink(categoryName: string) {
  const msg = `Hello Flag House Bangladesh, I'd like to inquire about: ${categoryName}.`;
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-4 p-5">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-auto inline-flex items-center justify-center gap-2 rounded-md bg-[#25D366] px-4 py-2.5 font-display text-xs font-semibold uppercase tracking-widest text-white shadow-sm transition-all hover:bg-[#1ebe57] hover:shadow-md"
              >
